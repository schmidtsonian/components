 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function k(t){let e=M.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},M.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const i=t.strings.join(h);return void 0===(s=e.keyString.get(i))&&(s=new u(t,t.getTemplateElement()),e.keyString.set(i,s)),e.stringsArray.set(t.strings,s),s}const M=new Map,U=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.1");const R=(t,...e)=>new S(t,e,"html",O),$=133;function j(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,$,null,!1);let r=F(i),o=i[r],a=-1,l=0;const h=[];let c=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===c&&(c=null),e.has(t)&&(h.push(t),null===c&&(c=t)),null!==c&&l++;void 0!==o&&o.index===a;)o.index=null!==c?-1:o.index-l,o=i[r=F(i,r)]}h.forEach(t=>t.parentNode.removeChild(t))}const q=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,$,null,!1);for(;s.nextNode();)e++;return e},F=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(_(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ht=(t=>(...e)=>{const s=t(...e);return i.set(s,!0),s})(t=>e=>{if(void 0===t&&e instanceof x){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)});customElements.define("image-text-loki",class extends lt{render(){return R`
      <figure>
        ...
        <div>
          ...
          <img 
            ...
            alt='${ht(this.alt)}' 
            width='${ht(this.width)}' 
            height='${ht(this.height)}'>
        </div>

        <div>
          <slot name='caption'></slot>
          ${this.caption?R`<figcaption>${this.caption}</figcaption>`:""}

          <slot name='description'></slot>
          ${this.description?R`<p>${this.description}</p>`:""}
          
          <slot name='link'></slot>
          <a href='${this.href}' title='${ht(this.linkTitle)}' target="${ht(this.target)}">
          ${this.linkTitle}
          </a>
        </div>
      </figure>
    `}static get properties(){return{src:{type:String},alt:{type:String},width:{type:Number},height:{type:Number},caption:{type:String},description:{type:String},href:{type:String},target:{type:String},linkTitle:{type:String}}}static get styles(){return ot`
      :host {
        display: block;
      }
